...
<comment-tag id="1" text="將容器改為垂直排列（flex-direction: column），這樣內層的報價單與操作按鈕才會從上到下自然陳列，不會左右並排。" type="suggestion">
           /* 預覽畫面的報價單：水平置中 */
           .quote-print {
             display: flex;
             justify-content: center;
...
<comment-tag id="2" text="修正 HTML 巢狀結構，將原本放錯層級導致浮動在螢幕右下角的按鈕區塊，直接放置在報價外框線 (.quote-sheet) 的結束標籤下方，並改用 Flex 置中對齊。" type="suggestion">
