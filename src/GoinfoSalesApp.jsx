...
export default function App() {
  ...
  const normalizeQuoteDetail = (raw) => {
    ...
    return { quote: { ...quote, SubtotalAmount: Number(quote.SubtotalAmount ?? quote.subtotalAmount ?? itemListAmount), TaxExcludedAmount: taxExcludedAmount, TaxAmount: taxAmount, TaxIncludedAmount: Number(quote.TaxIncludedAmount ?? quote.taxIncludedAmount ?? quote.TotalAmount ?? quote.totalAmount ?? itemListAmount * 1.05), DiscountAmount: Number(quote.DiscountAmount ?? quote.discountAmount ?? itemFinalAmount), TotalAmount: taxIncludedAmount, FinalAmount: taxIncludedAmount }, items };
  };
